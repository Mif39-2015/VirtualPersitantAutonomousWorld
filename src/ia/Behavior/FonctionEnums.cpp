...
map<string	, FONC_VOID			> MapEnumString::mapFoncVoid = {
	{"idle", IDLE}
	, {"eat", EAT}
	, {"dormir", DORMIR}
	, {"goto_haut", GOTO_HAUT}
...
map<string	, FONC_BOOL			> MapEnumString::mapFoncBool = {
...
map<string	, FONC_VOID_ENTITY	> MapEnumString::mapFoncVoidEntity = {
	{"goto", GoTo}
};
map<string	, FONC_INT_ENTITY	> MapEnumString::mapFoncIntEntity = {
	{"ag_getfaim", Fonc_GetFaim}
};
map<string	, FONC_ENTITY_ENTITY> MapEnumString::mapFoncEntityEntity = {
	{"get_hall_of", GetHallOf},
	{"get_nearest_of", GetNearestOf}
};
map<string 	, FONC_ENTITY 		> MapEnumString::mapFoncEntity = {
	{"GetArbre", GetArbre}
};
